...
const ForgottenPasswordNutritionist = () => {
  return (
    <div className="forgotten-password-nutritionist">
      <div className="jumbotron jb-forgotten d-flex align-items-center justify-content-center">
        <div className="d-flex justify-content-center col-12 my-5 row">
          <h1 className="d-flex justify-content-center text-white-color my-4">Un petit oubli, ça arrive à tout le monde ...</h1>
