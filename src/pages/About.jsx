    ...
    <div className="about page-padding">
        ...
        <div className="container">
          ...
          <div className="divcenter">
            ...
            <p>Nous vous proposons ici notre projet final, l'aboutissement de 6 mois d'apprentissage!</p>
        ...
        <div className="div-git">
          ...
          <div className="div-git-child">
            ...
            <a href="https://github.com/kleberkunha" target="_blank">Kleber Cunha</a>
          </div>
          <div className="div-git-child">
            <i class="fab fa-github"></i>
            <a href="https://github.com/aauugguussttiinn" target="_blank">Augustin Berne</a>
          </div>
          <div className="div-git-child">
            <i class="fab fa-github"></i>
            <a href="https://github.com/XabAyca" target="_blank">Xabi Aycaguer</a>
          </div>
          <div className="div-git-child">
            <i class="fab fa-github"></i>
            <a href="https://github.com/AnthonyLebro" target="_blank">Anthony Charron</a>
          </div>
          <div className="div-git-child">
            <i class="fab fa-github"></i>
            <a href="https://github.com/MathieuParadis" target="_blank">Mathieu Paradis</a>
          </div>
        </div>
    </div>
