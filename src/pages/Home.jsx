      ...
      <div className="home page-padding">
        ...
        <section className="section bg-blue align-items-center">
          <div className="section1-left">
            ...
            <h5 className="white-text-color pt-2 pb-4 text-justify">
              ...
              <div className="d-flex row div-btn-home-responsive">
                <div className=" my-2 d-flex col-sm-12 col-md-12 col-lg-12 col-xl-6">
                  <Link to="/signup-nutritionist" className="px-5 primary-button btn-lg btn-primary white-text-color ">
                    Je suis un nutritioniste
                  </Link>
                </div>
                <div className=" my-2 d-flex col-sm-12 col-md-12 col-lg-12 col-xl-6">
                  <Link to="/signup-patient" className="px-5 primary-button btn-lg btn-primary white-text-color">
                    Je suis un patient
                  </Link>
                </div>
              </div>}
        ...
        <section className="section bg-blue align-items-center">
          ...
          <div className="section3-right">
            <h2 className="white-text-color">Tableau de bord</h2>
            <h6 className="my-3 text-justified white-text-color">
            ...
            <Link to="/exemple/tableau-de-bord" className=" my-3 primary-button btn-sm btn-primary white-text-color">
              Découvrir
            </Link>
          </div>
        </section>
